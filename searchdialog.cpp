...
bool searchDialog::select_searchMotor()
{
    ...
    mem::PointerReleaser<db::IStatement> pStat(pDB->createStatement(db::IStatement::DBS_SELECT, "SELECT JobID, ID, Name, AliasName, Description, idNumberOfPhases, idRatedVoltage, nomMechPow, powerFactor, efficiency, loadFactor, rpm, Isu_In, r_x from CatAsynchronousMotor where JobID=? or EditFlag=?"));
...
bool searchDialog::select_searchMotorPla()
{
    ...
    mem::PointerReleaser<db::IStatement> pStat(pDB->createStatement(db::IStatement::DBS_SELECT, "SELECT JobID, SystemID, ID, Name, AliasName, Description, idPhaseCode, idCatalogType, idConnectionType from PlacAsynchronousMotor where JobID=? or EditFlag=?"));
...
bool searchDialog::select_searchUnitPla()
{
    ...
    mem::PointerReleaser<db::IStatement> pStat(pDB->createStatement(db::IStatement::DBS_SELECT, "SELECT JobID, SystemID, ID, Name, AliasName, Description, idPhaseCode, idCatalogType, idNodeType, idLoadType, idLoadDemandModel, desiredVoltage, grounded, rGround, xGround from PlacGeneratingUnit where JobID=? or EditFlag=?"));
...
bool searchDialog::select_searchShuntRes()
{
    ...
    mem::PointerReleaser<db::IStatement> pStat(pDB->createStatement(db::IStatement::DBS_SELECT, "SELECT JobID, SystemID, ID, Name, AliasName, Description, idCatalogType from PlacResistor where JobID=? or EditFlag=?"));
