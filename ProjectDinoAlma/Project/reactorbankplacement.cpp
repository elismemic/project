                                                     ...
                                                     QString phaseCode, int normalSection, QString loadDemandModel,int ID,int SystemID)
{
    ...
    db::StatementPtr pStat(pDB->createStatement(db::IStatement::DBS_INSERT,
       "INSERT INTO PlacementReactorBank(Description,Name,Alias,CatalogType,BankType,NoLoadControl,BankControl,PhaseCode,NormalSection,LoadDemandModel,JobID,TypeID,CatNamingID,SystemID) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)"));
