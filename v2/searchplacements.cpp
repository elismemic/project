...
bool SearchPlacements::connectSQLite()
{
    ...
    if (!pDB->connect("C:/Users/darko/Desktop/project.db"))
    {
...
void SearchPlacements::on_lineEdit_search_textChanged(const QString &arg1)
{
    selectPlacement();
}
