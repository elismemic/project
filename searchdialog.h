...
private:
    ...
    bool update_PlaMotorJobIdEditFlag(int oldJobID, int newJobID);
    bool updatePlaMotorEditFlag(int jobID, int EditFlag);
    bool updatePlaMotorEditFlagAfterAct(int oldEditFlag, int newEditFlag);

    bool update_PlaResistorJobIdEditFlag(int oldJobID, int newJobID);
    bool updatePlaResistorEditFlag(int jobID, int EditFlag);
    bool updatePlaResistorEditFlagAfterAct(int oldEditFlag, int newEditFlag);

    bool update_PlaUnitJobIdEditFlag(int oldJobID, int newJobID);
    bool updatePlaUnitEditFlag(int jobID, int EditFlag);
    bool updatePlaUnitEditFlagAfterAct(int oldEditFlag, int newEditFlag);
