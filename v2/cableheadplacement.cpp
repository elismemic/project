...
bool CableHeadPlacement::insertNaming(int uid, QString name, QString alias, int cattype, int phasecode, QString description, int type)
{
    ...
    db::StatementPtr pStat(pDB->createStatement(db::IStatement::DBS_INSERT, "Insert into PlacNaming VALUES(?,?,?,?,?,?,25)"));
...
bool CableHeadPlacement::deleteNaming(int uid){
    ...
    mem::PointerReleaser<db::IStatement> pStat(pDB->createStatement(db::IStatement::DBS_SELECT,"DELETE FROM PlacNaming where Id = ? and TypeId = 25"));
...
bool CableHeadPlacement::updateNaming(int uid, QString name, QString alias, int cattype, int phasecode, QString description, int type)
{
