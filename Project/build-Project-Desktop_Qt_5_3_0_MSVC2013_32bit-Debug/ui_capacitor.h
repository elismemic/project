...
public:
    ...
    void setupUi(QDialog *Capacitor)
    {
        ...
        capacitor_buttonBox->setStandardButtons(QDialogButtonBox::Cancel|QDialogButtonBox::Save);
    ...
    {
        Capacitor->setWindowTitle(QApplication::translate("Capacitor", "Dialog", 0));
