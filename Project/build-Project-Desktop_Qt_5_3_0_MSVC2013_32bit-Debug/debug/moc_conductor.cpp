...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Conductor_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 33, 21)
    ...
    "Conductor\0on_buttonBox_accepted\0\0"
...
const QMetaObject Conductor::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Conductor.data,
      qt_meta_data_Conductor,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Conductor.stringdata))
