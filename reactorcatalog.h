...
private:
    ...
    bool insertReactorNaming(int typeID,int id, QString name, int producerID);
    bool updateReactorCatalog(QString description, int ID,  QString alias,QString connectionType,QString numberOfPhases,
                              float ratedVoltage, float maximumVoltage,float minimumVoltage,int nominalSection,
                             float reactivePower, float activePowerLoss,float nominalCurrent, QString name
                               );

    bool updateReactorNaming(int typeID,int id, QString name, int producerID);
