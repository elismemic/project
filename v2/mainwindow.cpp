...
{
    SearchPlacements search;
    search.setPlacementType(5);
    search.exec();
}

void MainWindow::on_actionCable_Head_triggered()
{
    SearchPlacements search;
    search.setPlacementType(6);
    search.exec();
}
...
{
    SearchPlacements search;
    search.setPlacementType(7);
    search.exec();
}

void MainWindow::on_actionJumper_z_0_triggered()
{
    SearchPlacements myDialog;
    myDialog.setPlacementType(8);
    myDialog.exec();
}
